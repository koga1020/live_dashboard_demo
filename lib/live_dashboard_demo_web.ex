defmodule LiveDashboardDemoWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: LiveDashboardDemoWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/live_dashboard_demo_web/templates",
        namespace: LiveDashboardDemoWeb
